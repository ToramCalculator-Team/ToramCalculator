 ...
 * 用途：用于AttributeContainer等需要完整属性信息的场景
 */
...
// ============================== AttributeContainer相关类型 ==============================

/**
 * 属性表达式接口
 *
 * 用于AttributeContainer中存储属性的表达式信息
 */
 ...
 * Schema扁平化工具类
 *
 * 用于AttributeContainer中将嵌套Schema扁平化为可用的数据结构
 * 支持递归遍历、依赖关系分析和性能优化
 */
