...
import type { NodeGuardDefinition } from "../../BehaviourTreeDefinition";
import { Attribute, type AttributeDetails } from "../Attribute";
 ...
 */
export abstract class Guard extends Attribute<GuardAttributeDetails> {
	/**
	...
	constructor(
		type: string,
		private definition: NodeGuardDefinition,
	) {
