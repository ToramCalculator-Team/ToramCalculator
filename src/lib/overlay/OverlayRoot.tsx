...
function Dialog(props: {
	...
	return (
		<Show when={shouldRender()}>
			<div
				class="DialogHost fixed top-1/2 left-1/2 max-h-[70vh] w-full max-w-[50vw] -translate-x-1/2 -translate-y-1/2 portrait:max-w-[90vw] lg:max-w-240"
				classList={{ "h-[70vh]": layout() === "fill" }}
				style={{ "z-index": props.index }}
			>
				<Motion.div
					class="DialogMotion flex h-full w-full justify-center"
				...
				>
					<div
						role="application"
						class="DialogSurface bg-primary-color shadow-dividing-color shadow-dialog relative flex max-h-full w-full max-w-full flex-col items-center gap-3 rounded p-2"
