...
import { BtEditorWrapper } from "~/dataConfig/utils/BTEditorWrapper";
import { store } from "~/store";
import type { TableDataConfig, TableDataConfigurator } from "../data-config";

export const MOB_DATA_CONFIG: TableDataConfigurator<"mob", mob> = (dictionary) =>
	({
		fieldGroupMap: {
			ID: ["id"],
		...
		card: {
			...
			referencedBy: [
				{
					relation: "drop_item.belongToMob",
					tableName: "drop_item",
				},
			],
		},
	}) satisfies TableDataConfig<"mob", mob>;
