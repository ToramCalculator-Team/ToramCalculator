                                    ...
                                    return (
                                      <div class="ObjectBox border-dividing-color flex flex-col rounded-md border-1">
                                        ...
                                        <Index each={Object.entries(dropItem())}>
                                          {(dropItemField, index) => {
                                            const fieldKey =
                                              dropItemField()[0] as keyof weaponWithRelated["usedInDropItems"][number];
                                ...
                                <div class="ObjectBox border-dividing-color flex flex-col rounded-md border-1">
                                  ...
                                  <Index each={Object.entries(recipeEntry())}>
                                    {(recipeEntryField, index) => {
                                      const fieldKey =
                                        recipeEntryField()[0] as keyof weaponWithRelated["usedInRecipeEntries"][number];
                                ...
                                <div class="ObjectBox border-dividing-color flex flex-col rounded-md border-1">
                                  ...
                                  <Index each={Object.entries(taskReward())}>
                                    {(taskRewardField, index) => {
                                      const fieldKey =
                                        taskRewardField()[0] as keyof weaponWithRelated["usedInTaskRewards"][number];
