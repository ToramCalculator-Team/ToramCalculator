...
import { ElementType, ConsumableType, RecipeIngredientType, BossPartBreakRewardType, BossPartType } from "~/../db/kysely/enums";
                                    ...
                                    return (
                                      <div class="ObjectBox border-dividing-color flex flex-col rounded-md border-1">
                                        ...
                                        <Index each={Object.entries(dropItem())}>
                                          {(dropItemField, index) => {
                                            const fieldKey =
                                              dropItemField()[0] as keyof consumableWithRelated["usedInDropItems"][number];
                                ...
                                <div class="ObjectBox border-dividing-color flex flex-col rounded-md border-1">
                                  ...
                                  <Index each={Object.entries(taskReward())}>
                                    {(taskRewardField, index) => {
                                      const fieldKey =
                                        taskRewardField()[0] as keyof consumableWithRelated["usedInTaskRewards"][number];
                                ...
                                <div class="ObjectBox border-dividing-color flex flex-col rounded-md border-1">
                                  ...
                                  <Index each={Object.entries(recipeEntry())}>
                                    {(recipeEntryField, index) => {
                                      const fieldKey =
                                        recipeEntryField()[0] as keyof consumableWithRelated["usedInRecipeEntries"][number];
