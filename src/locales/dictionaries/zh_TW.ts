	...
	db: {
		...
		skill_variant: {
			...
			fields: {
				...
				motionFixed: {
					key: "固定動畫帧",
					tableFieldDescription: "固定動畫帧",
					formFieldDescription: "固定動畫帧",
				},
				motionModified: {
					key: "可加速動畫帧",
					tableFieldDescription: "可加速動畫帧",
					formFieldDescription: "可加速動畫帧",
				},
				chantingFixed: {
					key: "固定詠唱時間",
				...
				startupFrames: {
					key: "技能前搖",
					tableFieldDescription: "技能前搖",
					formFieldDescription: "技能前搖",
				},
				hpCost: {
					key: "HP消耗",
