...
const dictionary: Dictionary = {
	ui: {
		...
		simulator: {
			...
			//     anticipate: "看穿",
			//     index: "序号",
			//     skillVariantType: "读条类型",
			//     actionFixedMs: "固定动作时长（ms）",
			//     actionModifiedMs: "可加速动作时长（ms）",
			//     skillaction: "动作时长总值（ms）",
			//     chantingFixedMs: "固定咏唱时长（ms）",
			//     chantingModifiedMs: "可加速咏唱时长（ms）",
			//     skillchanting: "咏唱时长总值（ms）",
			//     chargingFixedMs: "固定蓄力时长（ms）",
			//     chargingModifiedMs: "可加速蓄力时长（ms）",
			//     skillcharging: "蓄力时长总值（ms）",
			//     skillDuration: "技能总耗时",
			//     skillstartup: "技能前摇（ms）",
			//     vMatk: "有效攻击力（魔法）",
			//     vPatk: "有效物攻（物理）",
			// },
			actualValue: "实际值",
	...
	db: {
		sync_heartbeat: {
			...
			fields: {
				id: {
					key: "ID",
					tableFieldDescription: "心跳记录ID",
					formFieldDescription: "心跳记录ID",
				},
				seq: {
					key: "序号",
					tableFieldDescription: "心跳自增序号",
					formFieldDescription: "心跳自增序号",
				},
				emitted_at: {
					key: "发出时间",
					tableFieldDescription: "服务端发出心跳的时间",
					formFieldDescription: "服务端发出心跳的时间",
				},
			},
			description: "数据同步延迟探针",
		},
		_armorTocrystal: {
			selfName: "防具-水晶关联",
			fields: {
		...
		_crystalTooption: {
			...
			fields: {
				...
				B: {
					key: "选项ID",
					tableFieldDescription: "关联的选项ID",
					formFieldDescription: "选择要关联的选项",
				},
			},
		...
		_crystalToplayer_armor: {
			...
			fields: {
				...
				B: {
					key: "玩家防具ID",
					tableFieldDescription: "关联的玩家防具ID",
					formFieldDescription: "选择要关联的玩家防具",
				},
			},
			description: "记录水晶和玩家防具之间的关联关系",
		},
		_crystalToplayer_option: {
			...
			fields: {
				...
				B: {
					key: "玩家追加ID",
					tableFieldDescription: "关联的玩家追加装备ID",
					formFieldDescription: "选择要关联的玩家追加装备",
				},
			},
			description: "记录水晶和玩家追加装备之间的关联关系",
		},
		_crystalToplayer_special: {
			...
			fields: {
				...
				B: {
					key: "玩家特殊ID",
					tableFieldDescription: "关联的玩家特殊装备ID",
					formFieldDescription: "选择要关联的玩家特殊装备",
				},
			},
			description: "记录水晶和玩家特殊装备之间的关联关系",
		},
		_crystalToplayer_weapon: {
			...
			fields: {
				...
				B: {
					key: "玩家武器ID",
					tableFieldDescription: "关联的玩家武器ID",
					formFieldDescription: "选择要关联的玩家武器",
				},
			},
			description: "记录水晶和玩家武器之间的关联关系",
		},
		_crystalTospecial: {
			selfName: "水晶-特殊装备关联",
			fields: {
				...
				B: {
					key: "特殊装备ID",
					tableFieldDescription: "关联的特殊装备ID",
					formFieldDescription: "选择要关联的特殊装备",
				},
			},
			description: "记录水晶和特殊装备之间的关联关系",
		},
		_crystalToweapon: {
			selfName: "水晶-武器关联",
			fields: {
				...
				B: {
					key: "武器ID",
					tableFieldDescription: "关联的武器ID",
					formFieldDescription: "选择要关联的武器",
				},
			},
			description: "记录水晶和武器之间的关联关系",
		},
		_frontRelation: {
			selfName: "前置关联",
			fields: {
				A: {
					key: "前置水晶ID",
					tableFieldDescription: "关联的前置水晶ID",
					formFieldDescription: "选择前置位水晶",
				},
				B: {
					key: "后置水晶ID",
					tableFieldDescription: "关联的后置水晶ID",
					formFieldDescription: "选择后置位水晶",
				},
			},
			description: "记录水晶之间的前置/后置关联关系",
		},
		_linkZones: {
			selfName: "区域连接",
			description: "记录区域之间的连接关系",
			fields: {
				A: {
					key: "区域A ID",
					tableFieldDescription: "连接的源区域ID",
					formFieldDescription: "选择要连接的源区域",
				},
				B: {
					key: "区域B ID",
					tableFieldDescription: "连接的目标区域ID",
					formFieldDescription: "选择要连接的目标区域",
				},
			},
		},
		_mobTozone: {
			...
			fields: {
				A: {
					key: "怪物ID",
					tableFieldDescription: "关联的怪物ID",
					formFieldDescription: "选择要关联的怪物",
				},
				B: {
					key: "区域ID",
					tableFieldDescription: "关联的区域ID",
					formFieldDescription: "选择要关联的区域",
				},
			},
		...
		activity: {
			...
			fields: {
				...
				createdAt: {
					key: "创建时间",
					tableFieldDescription: "该记录的创建时间",
					formFieldDescription: "创建时间由系统维护",
				},
				updatedAt: {
					key: "更新时间",
					tableFieldDescription: "该记录的最后更新时间",
					formFieldDescription: "更新时间由系统维护",
				},
				updatedByAccountId: {
					key: "更新者",
		...
		behavior_tree: {
			...
			fields: {
				id: {
					key: "ID",
					tableFieldDescription: "行为树唯一标识符",
					formFieldDescription: "行为树唯一标识符",
				},
				name: {
					key: "名称",
					tableFieldDescription: "行为树名称",
					formFieldDescription: "行为树名称",
				},
				definition: {
					key: "定义",
					tableFieldDescription: "MDSL 行为树定义",
				...
				activeOwnerId: {
					key: "主动归属技能变体",
					tableFieldDescription: "作为自定义主动行为树归属的技能变体",
					formFieldDescription: "作为自定义主动行为树归属的技能变体",
				},
				passiveOwnerId: {
					key: "被动归属技能变体",
					tableFieldDescription: "作为自定义被动行为树归属的技能变体",
					formFieldDescription: "作为自定义被动行为树归属的技能变体",
				},
				registeredOwnerId: {
					key: "长期注册归属技能变体",
					tableFieldDescription: "作为长期注册行为树归属的技能变体",
					formFieldDescription: "作为长期注册行为树归属的技能变体",
				},
			},
			description: "技能变体拥有的自定义行为树资源",
		},
		special: {
			selfName: "特殊装备",
			fields: {
