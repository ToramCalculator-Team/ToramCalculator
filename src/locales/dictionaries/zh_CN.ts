import { type Statistic } from "~/repositories/statistic";
import { type ConvertToAllString, type dictionary } from "./type";
import { Image } from "~/repositories/image";

const statistic: ConvertToAllString<Statistic> = {
  id: "ID",
  rates: "评分",
  ...
  db: {
    enums: {
      ...
      CrystalType: {
        ...
        AddEquip: "追加锻晶",
        Special: "特殊锻晶",
        PowerUpNormal: "通用强化锻晶",
        PowerUpWeapon: "武器强化锻晶",
        PowerUpArmor: "防具强化锻晶",
        PowerUpAddEquip: "追加强化锻晶",
        PowerUpSpecial: "特殊强化锻晶",
        selfName: "锻晶类型",
      },
      SkillTreeType: {
        BladeSkill: "剑术技能",
    ...
    models: {
      ...
      skillEffect: {
        ...
        subHand: "",
        description: "条件说明",
        motionFixed: "固定动作时长表达式（帧）",
        motionModified: "可加速动作时长表达式（帧）",
        reservoirFixed: "固定蓄力时长式表达式（秒）",
        reservoirModified: "可加速蓄力时长表达式（秒）",
        chantingFixed: "固定咏唱时长表达式（秒）",
        chantingModified: "可加速咏唱时长表达式（秒）",
        startupFrames: "技能前摇表达式（秒）",
      ...
      character: {
        ...
        agi: "基础敏捷",
        dex: "基础灵巧",
        personalityType: "特殊属性类型",
        personalityValue: "特殊属性值",
        weapon: {
          crystalList: "锻晶",
          id: "ID",
          name: "名称",
