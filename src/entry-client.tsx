...
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "analyzer" ADD CONSTRAINT "analyzer_monster_fkey" FOREIGN KEY ("monsterId") REFERENCES "public"."monster"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "analyzer" ADD CONSTRAINT "analyzer_character_fkey" FOREIGN KEY ("characterId") REFERENCES "public"."character"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
ALTER TABLE "process" ADD CONSTRAINT "process_belongToAnalyzer_fkey" FOREIGN KEY ("analyzerId") REFERENCES "public"."analyzer"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
const shape_vt = await pg.electric.syncShapeToTable({
  url: "http://localhost:3000/v1/shape/verification_token",
  table: "verification_token",
  primaryKey: ["identifier"],
  subscribe: true,
});
await pg.waitReady;
const ret = pg.live.query(`SELECT * FROM "verification_token"`, [], (res) => {
  console.log(res);
});

// const db = drizzle(pg, { schema });
// const ret = await db.query.verification_token.findMany();
// console.log(ret);
