...
export const getDataUrl = (svg: JSX.Element) => {
  // 创建一个 div 容器用于装载 JSX
    ...
    return (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path
          ...
          stroke-width="1.5"
        />
        <path d="M14 17L14 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10 17L10 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
        <path
...
export const Element = {
  Water: (props: JSX.IntrinsicElements["svg"]) => {
    return (
  ...
  Fire: (props: JSX.IntrinsicElements["svg"]) => {
    return (
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path
  ...
  Earth: (props: JSX.IntrinsicElements["svg"]) => {
    return (
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path
  ...
  Wind: (props: JSX.IntrinsicElements["svg"]) => {
    return (
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path
  ...
  NoElement: (props: JSX.IntrinsicElements["svg"]) => {
    return (
      <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g opacity="0.1">
