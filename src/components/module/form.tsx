                ...
                {(_field, index) => {
                  ...
                  return (
                    <form.Field name={fieldKey}>
                      {(field) => {
                        return fieldGenerator ? (
                          fieldGenerator(fieldKey, field, getFormValue, fieldValue.dictionary)
                        ) : (
                          <Input
                          ...
                          >
                            <div class="ArrayBox flex w-full flex-col gap-2">
                              <For each={field().state.value as string[]}>
                                {(item, index) => (
                                  <div class="flex items-center gap-2">
                                    <div class="flex-1">
                                      <Autocomplete
                                        ...
                                        setValue={(id) => {
                                          ...
                                          newArray[index()] = id;
                                          field().setValue(newArray as DeepValue<T, DeepKeys<T>>);
                                        }}
                                    ...
                                    <Button
                                      onClick={() => {
                                        const newArray = (field().state.value as string[]).filter(
                                          (_, i) => i !== index(),
                                        );
                                        field().setValue(newArray as DeepValue<T, DeepKeys<T>>);
                                      }}
