    ...
    <Presence exitBeforeEnter>
      <Show when={props.state}>
        ...
        >
          <div
            role="application"
            class={`DialogBox bg-primary-color shadow-dividing-color shadow-dialog relative flex max-h-[70vh] lg:max-w-240 w-full max-w-[50vw] portrait:max-w-[90vw] flex-col items-center gap-3 rounded p-2`}
            style={{
          ...
          >
            <div class="DialogTitle z-10 drop-shadow-dividing-color absolute -top-3 flex items-center drop-shadow-xl">
              ...
              <div class="bg-primary-color z-10 -mx-px py-0.75">
                <div class="border-boundary-color border-y py-0.75">
