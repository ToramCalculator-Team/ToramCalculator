        ...
        >
          <div class={`SettingForm flex h-dvh w-full flex-1 flex-col gap-3 rounded p-3 lg:max-w-7xl`}>
            ...
            <div class="FormContent flex flex-1 flex-row items-start overflow-hidden">
              <div class="Nav mr-3 hidden w-fit min-w-60 flex-col gap-2 rounded-md bg-transition-color-8 p-3 lg:flex">
              ...
              <OverlayScrollbarsComponent element="div" options={{ scrollbars: { autoHide: "scroll" } }} defer class="h-full">
                <div class="List flex h-full flex-1 flex-col items-stretch gap-5 rounded-md lg:gap-3">
                  ...
                  <div class="Module StatusAndSync flex flex-col gap-2 rounded-md bg-transition-color-8 p-1 lg:p-3">
                    ...
                    <div class="LabelGroup flex flex-col gap-1">
                      ...
                      <div class="SyncStateAcrossClients flex flex-1 flex-col items-start justify-between gap-4 rounded-md border-1.5 border-transition-color-20 bg-primary-color p-3 lg:flex-row lg:items-center">
                        ...
                        <Toggle
                          onclick={() =>
                            setStore("settings", "statusAndSync", "syncStateAcrossClients", (prev) => !prev)
                          }
