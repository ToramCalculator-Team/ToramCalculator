    ...
    <Presence exitBeforeEnter>
      <Show when={props.state}>
        <Motion.div
          ...
          class={`DialogBox fixed justify-center left-0 top-0 z-50 flex h-dvh w-dvw bg-primary-color-90 opacity-0`}
        >
          <div class={`DialogCloseBtn hidden lg:block flex-1 cursor-pointer`} onClick={handleClose}></div>
          <Motion.div
