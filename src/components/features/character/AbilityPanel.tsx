		...
		<div class="AbilityConfig flex flex-col gap-2">
			<div class="Level flex flex-col gap-2">
				...
				<RangeInput
					...
					setValue={(value) => props.onChangeRequested("lv", value)}
					min={1}
					max={300}
					showSlider={false}
				/>
			...
			<div class="Ability flex flex-col gap-2">
				...
				<div class="AbilityValueGroup flex flex-col gap-2">
					<div class="Str flex items-center gap-2">
						...
						<RangeInput value={props.slots.str} setValue={(value) => props.onChangeRequested("str", value)} min={1} />
					</div>
					<div class="Int flex items-center gap-2">
						<div class="IntLabel">{dictionary().db.character.fields.int.key}</div>
						<RangeInput value={props.slots.int} setValue={(value) => props.onChangeRequested("int", value)} min={1} />
					</div>
					<div class="Vit flex items-center gap-2">
						<div class="VitLabel">{dictionary().db.character.fields.vit.key}</div>
						<RangeInput value={props.slots.vit} setValue={(value) => props.onChangeRequested("vit", value)} min={1} />
					</div>
					<div class="Agi flex items-center gap-2">
						<div class="AgiLabel">{dictionary().db.character.fields.agi.key}</div>
						<RangeInput value={props.slots.agi} setValue={(value) => props.onChangeRequested("agi", value)} min={1} />
					</div>
					<div class="Dex flex items-center gap-2">
						<div class="DexLabel">{dictionary().db.character.fields.dex.key}</div>
						<RangeInput value={props.slots.dex} setValue={(value) => props.onChangeRequested("dex", value)} min={1} />
					</div>
				</div>
			</div>
			<div class="PersonalityType flex flex-col gap-2">
				...
				<Select
					...
					setValue={(value) => props.onChangeRequested("personalityType", value as CharacterPersonalityType)}
					options={[
			...
			<div class="PersonalityValue flex flex-col gap-2">
				...
				<RangeInput
					...
					setValue={(value) => props.onChangeRequested("personalityValue", value)}
					min={1}
					max={255}
					showSlider={false}
				/>
