...
export const CharacterAttrName: Record<CharacterAttrEnum, string> = {
  [CharacterAttrEnum.LV]: "等级",
  [CharacterAttrEnum.STR]: "力量",
  [CharacterAttrEnum.INT]: "智力",
  [CharacterAttrEnum.VIT]: "体力",
  [CharacterAttrEnum.AGI]: "敏捷",
  [CharacterAttrEnum.DEX]: "灵巧",
  [CharacterAttrEnum.LUK]: "幸运",
  [CharacterAttrEnum.TEC]: "技巧",
  [CharacterAttrEnum.MEN]: "异抗",
  [CharacterAttrEnum.CRI]: "暴击",
  [CharacterAttrEnum.MAX_MP]: "最大MP",
  [CharacterAttrEnum.AGGRO_RATE]: "仇恨倍率",
  [CharacterAttrEnum.WEAPON_RANGE]: "武器范围",
  [CharacterAttrEnum.HP_REGEN]: "HP自然恢复",
  [CharacterAttrEnum.MP_REGEN]: "MP自然恢复",
  [CharacterAttrEnum.MP_ATK_REGEN]: "MP攻击恢复",
  [CharacterAttrEnum.PHYSICAL_ATK]: "物理攻击",
  [CharacterAttrEnum.MAGICAL_ATK]: "魔法攻击",
  [CharacterAttrEnum.WEAPON_ATK]: "武器攻击",
  [CharacterAttrEnum.UNSHEATHE_ATK]: "拔刀攻击",
  [CharacterAttrEnum.PHYSICAL_PIERCE]: "物理穿透",
  [CharacterAttrEnum.MAGICAL_PIERCE]: "魔法穿透",
  [CharacterAttrEnum.PHYSICAL_CRITICAL_RATE]: "物理暴击率",
  [CharacterAttrEnum.PHYSICAL_CRITICAL_DAMAGE]: "物理暴击伤害",
  [CharacterAttrEnum.MAGICAL_CRT_CONVERSION_RATE]: "魔法暴击率转换",
  [CharacterAttrEnum.MAGICAL_CRT_DAMAGE_CONVERSION_RATE]: "魔法暴击伤害转换",
  [CharacterAttrEnum.MAGICAL_CRITICAL_RATE]: "魔法暴击率",
  [CharacterAttrEnum.MAGICAL_CRITICAL_DAMAGE]: "魔法暴击伤害",
  [CharacterAttrEnum.SHORT_RANGE_DAMAGE]: "近距离威力",
  [CharacterAttrEnum.LONG_RANGE_DAMAGE]: "远距离威力",
  [CharacterAttrEnum.STRONGER_AGAINST_NETURAL]: "对无属性增强",
  [CharacterAttrEnum.STRONGER_AGAINST_Light]: "对光属性增强",
  [CharacterAttrEnum.STRONGER_AGAINST_Dark]: "对暗属性增强",
  [CharacterAttrEnum.STRONGER_AGAINST_Water]: "对水属性增强",
  [CharacterAttrEnum.STRONGER_AGAINST_Fire]: "对火属性增强",
  [CharacterAttrEnum.STRONGER_AGAINST_Earth]: "对地属性增强",
  [CharacterAttrEnum.STRONGER_AGAINST_Wind]: "对风属性增强",
  [CharacterAttrEnum.TOTAL_DAMAGE]: "总伤害",
  [CharacterAttrEnum.FINAL_DAMAGE]: "最终伤害",
  [CharacterAttrEnum.PHYSICAL_STABILITY]: "物理稳定率",
  [CharacterAttrEnum.MAGIC_STABILITY]: "魔法稳定率",
  [CharacterAttrEnum.ACCURACY]: "命中",
  [CharacterAttrEnum.ADDITIONAL_PHYSICS]: "物理追击",
  [CharacterAttrEnum.ADDITIONAL_MAGIC]: "魔法追击",
  [CharacterAttrEnum.ANTICIPATE]: "看穿",
  [CharacterAttrEnum.GUARD_BREAK]: "破防",
  [CharacterAttrEnum.REFLECT]: "反弹伤害",
  [CharacterAttrEnum.ABSOLUTA_ACCURACY]: "绝对命中",
  [CharacterAttrEnum.ATK_UP_STR]: "物理攻击提升（力量）",
  [CharacterAttrEnum.ATK_UP_INT]: "物理攻击提升（智力）",
  [CharacterAttrEnum.ATK_UP_VIT]: "物理攻击提升（耐力）",
  [CharacterAttrEnum.ATK_UP_AGI]: "物理攻击提升（敏捷）",
  [CharacterAttrEnum.ATK_UP_DEX]: "物理攻击提升（灵巧）",
  [CharacterAttrEnum.MATK_UP_STR]: "魔法攻击提升（力量）",
  [CharacterAttrEnum.MATK_UP_INT]: "魔法攻击提升（智力）",
  [CharacterAttrEnum.MATK_UP_VIT]: "魔法攻击提升（耐力）",
  [CharacterAttrEnum.MATK_UP_AGI]: "魔法攻击提升（敏捷）",
  [CharacterAttrEnum.MATK_UP_DEX]: "魔法攻击提升（灵巧）",
  [CharacterAttrEnum.ATK_DOWN_STR]: "物理攻击降低（力量）",
  [CharacterAttrEnum.ATK_DOWN_INT]: "物理攻击降低（智力）",
  [CharacterAttrEnum.ATK_DOWN_VIT]: "物理攻击降低（耐力）",
  [CharacterAttrEnum.ATK_DOWN_AGI]: "物理攻击降低（敏捷）",
  [CharacterAttrEnum.ATK_DOWN_DEX]: "物理攻击降低（灵巧）",
  [CharacterAttrEnum.MATK_DOWN_STR]: "魔法攻击降低（力量）",
  [CharacterAttrEnum.MATK_DOWN_INT]: "魔法攻击降低（智力）",
  [CharacterAttrEnum.MATK_DOWN_VIT]: "魔法攻击降低（耐力）",
  [CharacterAttrEnum.MATK_DOWN_AGI]: "魔法攻击降低（敏捷）",
  [CharacterAttrEnum.MATK_DOWN_DEX]: "魔法攻击降低（灵巧）",
  [CharacterAttrEnum.MAX_HP]: "最大HP",
  [CharacterAttrEnum.BODYARMOR_DEF]: "防具防御",
  [CharacterAttrEnum.PHYSICAL_DEF]: "物理防御",
  [CharacterAttrEnum.MAGICAL_DEF]: "魔法防御",
  [CharacterAttrEnum.PHYSICAL_RESISTANCE]: "物理抗性",
  [CharacterAttrEnum.MAGICAL_RESISTANCE]: "魔法抗性",
  [CharacterAttrEnum.NEUTRAL_RESISTANCE]: "无属性抗性",
  [CharacterAttrEnum.Light_RESISTANCE]: "光属性抗性",
  [CharacterAttrEnum.Dark_RESISTANCE]: "暗属性抗性",
  [CharacterAttrEnum.Water_RESISTANCE]: "水属性抗性",
  [CharacterAttrEnum.Fire_RESISTANCE]: "火属性抗性",
  [CharacterAttrEnum.Earth_RESISTANCE]: "地属性抗性",
  [CharacterAttrEnum.Wind_RESISTANCE]: "风属性抗性",
  [CharacterAttrEnum.DODGE]: "回避",
  [CharacterAttrEnum.AILMENT_RESISTANCE]: "异常抗性",
  [CharacterAttrEnum.GUARD_POWER]: "格挡力",
  [CharacterAttrEnum.GUARD_RECHANGE]: "格挡力恢复",
  [CharacterAttrEnum.EVASION_RECHARGE]: "回避力恢复",
  [CharacterAttrEnum.PHYSICAL_BARRIER]: "物理屏障",
  [CharacterAttrEnum.MAGICAL_BARRIER]: "魔法屏障",
  [CharacterAttrEnum.FRACTIONAL_BARRIER]: "百分比屏障",
  [CharacterAttrEnum.BARRIER_COOLDOWN]: "屏障回复速度",
  [CharacterAttrEnum.REDUCE_DMG_FLOOR]: "地面伤害减轻",
  [CharacterAttrEnum.REDUCE_DMG_METEOR]: "陨石伤害减轻",
  [CharacterAttrEnum.REDUCE_DMG_PLAYER_EPICENTER]: "范围伤害减轻（以玩家为中心）",
  [CharacterAttrEnum.REDUCE_DMG_FOE_EPICENTER]: "范围伤害减轻（以怪物为中心）",
  [CharacterAttrEnum.REDUCE_DMG_BOWLING]: "贴地伤害减轻",
  [CharacterAttrEnum.REDUCE_DMG_BULLET]: "子弹伤害减轻",
  [CharacterAttrEnum.REDUCE_DMG_STRAIGHT_LINE]: "直线伤害减轻",
  [CharacterAttrEnum.REDUCE_DMG_CHARGE]: "冲撞伤害减轻",
  [CharacterAttrEnum.ABSOLUTE_DODGE]: "绝对回避",
  [CharacterAttrEnum.ASPD]: "攻击速度",
  [CharacterAttrEnum.MSPD]: "咏唱速度",
  [CharacterAttrEnum.MSRD]: "咏唱缩减",
  [CharacterAttrEnum.CSPD]: "施法速度",
  [CharacterAttrEnum.CSRD]: "施法缩减",
  [CharacterAttrEnum.DROP_RATE]: "掉落率",
  [CharacterAttrEnum.REVIVE_TIME]: "复活时间",
  [CharacterAttrEnum.FLINCH_UNAVAILABLE]: "无法被击退",
  [CharacterAttrEnum.TUMBLE_UNAVAILABLE]: "无法被击飞",
  [CharacterAttrEnum.STUN_UNAVAILABLE]: "无法被击晕",
  [CharacterAttrEnum.INVINCIBLE_AID]: "无敌",
  [CharacterAttrEnum.EXP_RATE]: "经验倍率",
  [CharacterAttrEnum.PET_EXP]: "宠物经验",
  [CharacterAttrEnum.ITEM_COOLDOWN]: "物品冷却时间",
  [CharacterAttrEnum.RECOIL_DAMAGE]: "反冲伤害",
  [CharacterAttrEnum.GEM_POWDER_DROP]: "宝石粉末掉落",
  [CharacterAttrEnum.WEAPON_MATK_CONVERSION_RATE]: "武器魔法攻击转换",
  [CharacterAttrEnum.WEAPON_ATK_CONVERSION_RATE]: "武器物理攻击转换",
  [CharacterAttrEnum.MAINWEAPON_BASE_VALUE]: "主武器基础值",
  [CharacterAttrEnum.MAINWEAPON_ATK]: "主武器攻击",
  [CharacterAttrEnum.SUBWEAPON_BASE_VALUE]: "副武器基础值",
  [CharacterAttrEnum.SUBWEAPON_ATK]: "副武器攻击",
  [CharacterAttrEnum.BODYARMOR_BASE_VALUE]: "防具基础值",
}
