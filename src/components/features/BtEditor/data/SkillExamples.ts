...
const magic_cannon_definition = `root {
    selector {
        sequence{
...
const magic_cannon_agent = `class Agent {
}`;

const magic_cannon_buff1_definition = `root {
    sequence {
        action [添加计数器, "魔法炮充能"]
...
const magic_cannon_buff1_agent = `class Agent {
  get 一类技能列表 () {
