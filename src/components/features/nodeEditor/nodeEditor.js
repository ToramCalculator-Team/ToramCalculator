export default class Drawflow {
    ...
    start () {
      ...
      this.container.addEventListener('touchmove', this.position.bind(this), { passive: false });
      this.container.addEventListener('touchstart', this.click.bind(this), { passive: false });
      ...
      /* Zoom Mouse */
      this.container.addEventListener('wheel', this.zoom_enter.bind(this), { passive: false });
      /* Update data Nodes */
