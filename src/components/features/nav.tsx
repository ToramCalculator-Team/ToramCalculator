...
export const Nav = () => {
	...
	return (
        ...
        landscape:left-[4vh]
        landscape:py-5
        landscape:bg-primary-color-30
        landscape:backdrop-blur
        landscape:rounded
        landscape:shadow-dividing-color
        landscape:shadow-dialog
        lg:landscape:static 
        lg:landscape:h-full
        lg:landscape:shadow-none
        lg:landscape:rounded-none
        lg:landscape:flex 
		...
		>
			...
			>
				...
				>
					<div
						class={`NavBtnGroup item-center flex shrink landscape:flex-col ${display() ? "lg:landscape:opacity-100" : "lg:landscape:opacity-0"}`}
					>
						<NavBtn
							config={{
