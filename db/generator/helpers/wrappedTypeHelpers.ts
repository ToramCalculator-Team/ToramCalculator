 ...
 */
export const convertToWrappedTypes = (modelDefinition: ts.TypeAliasDeclaration): ts.TypeAliasDeclaration[] => {
	...
	return [
		...
		ts.factory.createTypeAliasDeclaration(
			...
			undefined,
			ts.factory.createTypeReferenceNode("Selectable", [ts.factory.createTypeReferenceNode(tableTypeName, undefined)]),
		),
		ts.factory.createTypeAliasDeclaration(
			[ts.factory.createModifier(ts.SyntaxKind.ExportKeyword)],
			ts.factory.createIdentifier(`New${modelName}`),
			undefined,
			ts.factory.createTypeReferenceNode("Insertable", [ts.factory.createTypeReferenceNode(tableTypeName, undefined)]),
		),
		ts.factory.createTypeAliasDeclaration(
			[ts.factory.createModifier(ts.SyntaxKind.ExportKeyword)],
			ts.factory.createIdentifier(`${modelName}Update`),
			undefined,
			ts.factory.createTypeReferenceNode("Updateable", [ts.factory.createTypeReferenceNode(tableTypeName, undefined)]),
		),
	];
};
