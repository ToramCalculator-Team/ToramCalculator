...
-- Name: _simulatorTomember; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."_simulatorTomember" (
    "A" text NOT NULL,
    "B" text NOT NULL
);


ALTER TABLE public."_simulatorTomember" OWNER TO postgres;

--
-- TOC entry 217 (class 1259 OID 16779)
-- Name: _simulatorTomob; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."_simulatorTomob" (
    "A" text NOT NULL,
    "B" text NOT NULL
);


ALTER TABLE public."_simulatorTomob" OWNER TO postgres;
...
-- Dependencies: 216
-- Data for Name: _simulatorTomember; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."_simulatorTomember" ("A", "B") FROM stdin;
testSimulatorId	testMemberId
\.
...
-- Dependencies: 217
-- Data for Name: _simulatorTomob; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."_simulatorTomob" ("A", "B") FROM stdin;
testSimulatorId	testMobId
\.
...
COPY public.additional_equipment (id, name, refinement, "modifierListId", "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
...
COPY public.simulator (id, name, "extraDetails", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
testSimulatorId	测试分析器	\N	2024-11-01 03:16:37.312	1970-01-01 00:00:00	testSimulatorStatistics	\N	\N
\.
...
COPY public.body_armor (id, name, "bodyArmorType", refinement, "baseDef", "modifierListId", "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
...
COPY public.combo (id, name, "createdByAccountId") FROM stdin;
\.
...
COPY public.consumable (id, name, "modifierListId", "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
\.
...
COPY public.crystal (id, name, "crystalType", front, "modifierListId", "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
...
COPY public.main_weapon (id, name, "mainWeaponType", "baseAtk", refinement, stability, element, "modifierListId", "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
...
clui589ck000311my0p5bgm0o	出土魔像	COMMON_BOSS	16	90	渊底的遗迹·最深处	Normal	1	3150	12	0	12	0	0	12	0	10	0	15	15	0	0	0	0	无	fengli	2024-04-03 04:11:55.193	2024-04-28 03:48:20.696	93	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
clui7cvao001111myok0n3ps3	獠牙王	COMMON_BOSS	62	3000	萨哈姆地下洞穴·最深处	Normal	1	0	62	2	62	2	0	279	4	8	0	10	10	0	0	0	0	无	fengli	2024-04-03 07:01:07.627	2024-04-28 03:48:20.696	92	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clusdojrh000511x43obnruzj	葛瓦	COMMON_BOSS	82	5000	阿卡克废城·城外荒郊	Normal	1	0	41	3	41	3	0	246	5	5	0	10	10	5	5	5	5	无	fengli	2024-04-09 12:47:13.976	2024-04-28 03:48:20.696	75	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
cluv8ijit0005u048knmhxyp9	薄暮巨龙	COMMON_BOSS	100	8000	索费尼山岳要塞·屋顶	Normal	1	0	180	4	260	4	0	255	6	12	0	20	30	5	5	5	0	无	fengli	2024-04-11 12:47:49.435	2024-04-28 03:48:59.786	68	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
cluv8t0860009u048a24icquk	嗜人蝎狮	COMMON_BOSS	100	14400	暗之城·第二区	Normal	1	0	220	4	242	4	0	248	3	9	0	20	40	5	5	5	0	无	fengli	2024-04-11 12:55:57.672	2024-04-28 03:48:59.786	65	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
cluv8uzts000bu048su2ccp8x	魔晶炮手	COMMON_BOSS	103	7610	战士摇篮·最深处	Normal	1	0	216	4	247	4	0	123	1	20	0	40	50	5	5	5	0	无	fengli	2024-04-11 12:57:30.426	2024-04-28 03:48:59.786	64	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
cluvgo77p000nu048109v4tal	约克	COMMON_BOSS	118	6800	巨型水晶工厂·储藏库	Normal	1	0	295	4	118	4	0	275	10	5	0	40	0	5	5	5	0	无	fengli	2024-04-11 16:36:10.287	2024-04-28 03:48:59.786	59	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
cluvgvr59000pu048jlo772t4	热带梦貘	COMMON_BOSS	120	7800	烧灼裂谷·地面	Normal	1	7813000	144	4	168	4	0	360	5	5	0	25	40	5	5	5	0	睡着了会回血	fengli	2024-04-11 16:43:54.352	2024-04-28 03:48:59.786	57	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
cluvh0ial000ru048060ee4vn	半魔像暴君	COMMON_BOSS	121	8400	小型半魔像制造厂·中枢	Normal	1	0	61	4	61	4	0	543	6	10	0	10	10	0	5	5	0	无	fengli	2024-04-11 16:45:44.61	2024-04-28 03:48:59.786	56	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
cluvh2f6u000tu0488nxl4vy8	龙兽半魔像	COMMON_BOSS	124	12240	大型半魔像制造厂·最深处	Normal	1	0	248	15	372	15	0	186	2	20	0	50	50	5	5	5	0	无	fengli	2024-04-11 16:47:13.85	2024-04-28 03:48:59.786	55	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
cluvhcvnx0013u048kumee5cx	重装魔偶·红	COMMON_BOSS	133	6200	布莱耶研究所·4号楼	Normal	1	0	399	30	0	30	0	299	0	0	0	5	5	5	5	5	0	无	fengli	2024-04-11 16:55:21.803	2024-04-28 03:48:59.786	50	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
cluvhh45f0017u048xpsrfz4d	终极半魔像	COMMON_BOSS	139	10500	多洛马广场	Normal	1	0	417	10	417	10	15	208	0	9	0	30	15	5	5	5	0	无	fengli	2024-04-11 16:58:39.419	2024-04-28 03:48:59.786	48	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clv6u40id000lwv1fw2chusr7	佛拉布喇·近	COMMON_BOSS	184	19190	雷赛塔拉地区·集货所屋顶	Normal	1	5150000	552	21	184	7	0	276	0	14	0	100	100	5	5	5	0	仇恨值目标7m内时的状态	fengli	2024-04-19 15:37:52.282	2024-04-28 04:02:19.801	32	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clv6u8d9t000nwv1fjbmbyohh	佛拉布喇·远	COMMON_BOSS	184	19190	雷赛塔拉地区·集货所屋顶	Normal	1	5150000	184	7	736	21	0	552	21	0	0	100	100	5	5	5	0	仇恨值目标在7m外时的状态	fengli	2024-04-19 15:41:15.437	2024-04-28 04:02:19.801	30	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clv6v144a000zwv1frhv71fxi	王座柯尔连生体	COMMON_BOSS	190	0	新·原生质体	Normal	1	0	665	7	475	7	25	285	0	6	0	5	20	5	5	5	0	无	fengli	2024-04-19 16:03:53.881	2024-04-28 04:02:19.801	26	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clv6vgjhg0017wv1fkdtn4tb8	移儡原生质体	COMMON_BOSS	205	14460	诺芙·蒂拉·中央区	Normal	1	0	922	8	307	8	100	307	0	25	0	1	1	5	5	5	0	受到冰冻后，暴击抗性降低为零；生命值降低至75%以下时，属性变为风属性	fengli	2024-04-19 16:15:36.342	2024-04-28 04:02:19.801	21	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clv6vuo5d001fwv1fg5wuac1z	卒龙灾比欧	COMMON_BOSS	214	16200	建材放置处·竞技场	Normal	1	0	642	8	535	8	20	642	10	0	0	10	5	5	5	5	0	单次伤害超过50万会召唤小怪。	fengli	2024-04-19 16:26:35.569	2024-04-28 04:02:19.801	18	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clv6wboec001lwv1ftpa30r93	威琉魔	COMMON_BOSS	223	20600	原生质体要塞·最深处	Normal	1	0	892	8	892	8	25	334	0	30	5	5	10	5	5	5	0	按距离变色，紫色抗性增加	fengli	2024-04-19 16:39:49.023	2024-04-28 04:02:19.801	16	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clv6wmh4w001rwv1f8aa3u6vh	护卫魔像	COMMON_BOSS	232	38000	龙人之喉	Normal	1	0	1160	25	1160	25	20	418	0	25	0	0	0	5	5	5	0	血量低于50%以后切换形态；红色形态的回血期间受到麻痹会被打断。	fengli	2024-04-19 16:48:12.807	2024-04-28 04:02:19.801	13	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
clv6y2u4t0023wv1f6o35glva	乐龙雷多尔基	COMMON_BOSS	250	28900	波玛·空达·村落中心	Normal	1	7000000	500	10	875	10	35	375	0	0	0	3	5	5	5	5	0	受到翻覆后会反击（即使翻覆由boss自身的技能施加）	fengli	2024-04-19 17:28:55.676	2024-04-28 04:02:19.801	7	system	cluhz95c5000078elg5r46i83	cluhz95c5000078elg5r46i83
...
COPY public.pet (id, name, "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
...
COPY public.skill (id, "skillTreeName", name, "skillType", "weaponElementDependencyType", element, "skillDescription", "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
\.
...
COPY public.special_equipment (id, name, "modifierListId", "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
...
COPY public.statistics (id, "monsterId", "crystalId", "mainWeaponId", "subWeaponId", "bodyArmorId", "additionalEquipmentId", "specialEquipmentId", "skillId", "petId", "consumableId", "characterId", "simulatorId") FROM stdin;
...
testSimulatorStatistics	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.
...
COPY public.sub_weapon (id, name, "subWeaponType", "baseAtk", refinement, stability, element, "modifierListId", "extraDetails", "dataSources", "updatedAt", "createdAt", "statisticsId", "updatedByAccountId", "createdByAccountId") FROM stdin;
testSubWeapon	测试-副武器风遁	NINJUTSUSCROLL	0	0	0	Normal	windScrollModifiersList	null	null	2024-10-13 07:06:46.62	1970-01-01 00:00:00	testSubWeaponStatistics	\N	\N
\.
...
-- Name: _simulatorTomember_AB_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "_simulatorTomember_AB_unique" ON public."_simulatorTomember" USING btree ("A", "B");


--
-- TOC entry 3474 (class 1259 OID 17069)
-- Name: _simulatorTomember_B_index; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "_simulatorTomember_B_index" ON public."_simulatorTomember" USING btree ("B");


--
-- TOC entry 3475 (class 1259 OID 17070)
-- Name: _simulatorTomob_AB_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "_simulatorTomob_AB_unique" ON public."_simulatorTomob" USING btree ("A", "B");


--
-- TOC entry 3476 (class 1259 OID 17071)
-- Name: _simulatorTomob_B_index; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "_simulatorTomob_B_index" ON public."_simulatorTomob" USING btree ("B");
...
-- Name: simulator_statisticsId_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "simulator_statisticsId_key" ON public.simulator USING btree ("statisticsId");
...
-- Name: _simulatorTomember _simulatorTomember_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."_simulatorTomember"
    ADD CONSTRAINT "_simulatorTomember_A_fkey" FOREIGN KEY ("A") REFERENCES public.simulator(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 3584 (class 2606 OID 17121)
-- Name: _simulatorTomember _simulatorTomember_B_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."_simulatorTomember"
    ADD CONSTRAINT "_simulatorTomember_B_fkey" FOREIGN KEY ("B") REFERENCES public.member(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 3585 (class 2606 OID 17126)
-- Name: _simulatorTomob _simulatorTomob_A_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."_simulatorTomob"
    ADD CONSTRAINT "_simulatorTomob_A_fkey" FOREIGN KEY ("A") REFERENCES public.simulator(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 3586 (class 2606 OID 17131)
-- Name: _simulatorTomob _simulatorTomob_B_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."_simulatorTomob"
    ADD CONSTRAINT "_simulatorTomob_B_fkey" FOREIGN KEY ("B") REFERENCES public.mob(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
-- Name: additional_equipment additional_equipment_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.additional_equipment
    ADD CONSTRAINT "additional_equipment_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: additional_equipment additional_equipment_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.additional_equipment
    ADD CONSTRAINT "additional_equipment_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public.simulator
    ADD CONSTRAINT "simulator_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;


--
-- TOC entry 3605 (class 2606 OID 17226)
-- Name: simulator simulator_statisticsId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.simulator
    ADD CONSTRAINT "simulator_statisticsId_fkey" FOREIGN KEY ("statisticsId") REFERENCES public.statistics(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
ALTER TABLE ONLY public.simulator
    ADD CONSTRAINT "simulator_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;


--
-- TOC entry 3607 (class 2606 OID 17236)
-- Name: body_armor body_armor_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.body_armor
    ADD CONSTRAINT "body_armor_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: body_armor body_armor_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.body_armor
    ADD CONSTRAINT "body_armor_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: character character_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."character"
    ADD CONSTRAINT "character_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: character character_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."character"
    ADD CONSTRAINT "character_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;


--
-- TOC entry 3624 (class 2606 OID 17321)
-- Name: combo combo_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.combo
    ADD CONSTRAINT "combo_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: consumable consumable_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.consumable
    ADD CONSTRAINT "consumable_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: consumable consumable_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.consumable
    ADD CONSTRAINT "consumable_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;


--
-- TOC entry 3631 (class 2606 OID 17356)
-- Name: crystal crystal_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.crystal
    ADD CONSTRAINT "crystal_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: crystal crystal_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.crystal
    ADD CONSTRAINT "crystal_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: main_weapon main_weapon_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.main_weapon
    ADD CONSTRAINT "main_weapon_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: main_weapon main_weapon_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.main_weapon
    ADD CONSTRAINT "main_weapon_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: monster monster_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monster
    ADD CONSTRAINT "monster_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: monster monster_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.monster
    ADD CONSTRAINT "monster_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;


--
-- TOC entry 3651 (class 2606 OID 17456)
-- Name: pet pet_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pet
    ADD CONSTRAINT "pet_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: pet pet_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pet
    ADD CONSTRAINT "pet_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public.skill
    ADD CONSTRAINT "skill_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public.skill
    ADD CONSTRAINT "skill_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: special_equipment special_equipment_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.special_equipment
    ADD CONSTRAINT "special_equipment_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: special_equipment special_equipment_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.special_equipment
    ADD CONSTRAINT "special_equipment_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: sub_weapon sub_weapon_createdByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sub_weapon
    ADD CONSTRAINT "sub_weapon_createdByAccountId_fkey" FOREIGN KEY ("createdByAccountId") REFERENCES public.user_create_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
...
-- Name: sub_weapon sub_weapon_updatedByAccountId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sub_weapon
    ADD CONSTRAINT "sub_weapon_updatedByAccountId_fkey" FOREIGN KEY ("updatedByAccountId") REFERENCES public.user_update_data("userId") ON UPDATE CASCADE ON DELETE SET NULL;
